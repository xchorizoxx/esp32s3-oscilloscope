...
class ChannelPanel(QWidget):
    ...
    # Senales: offset_mv, v_div_idx, attenuation_idx, coupling_str, visible
    ...
    def __init__(self, title: str, color_hex: str, parent=None):
        ...
        self.scales_mv = [10, 20, 50, 100, 200, 500, 1000, 2000, 5000, 10000, 20000, 50000]
        ...
        # BUG-M07 FIX: slider cubre el rango completo del spinbox
        ...
        self.cb_coupling.addItems(["AC+DC", "AC", "DC", "GND"])
